...
interface Mixpanel
{
	...
	// +(Mixpanel * _Nonnull)sharedInstanceWithToken:(NSString * _Nonnull)apiToken launchOptions:(NSDictionary * _Nonnull)launchOptions trackCrashes:(BOOL)trackCrashes automaticPushTracking:(BOOL)automaticPushTracking;
	[Static]
	[Export ("sharedInstanceWithToken:launchOptions:trackCrashes:automaticPushTracking:")]
	Mixpanel SharedInstanceWithToken (string apiToken, NSDictionary launchOptions, bool trackCrashes, bool automaticPushTracking);
...
{
	// extern double MixpanelVersionNumber;
	[Field ("MixpanelVersionNumber", "__Internal")]
	double MixpanelVersionNumber { get; }

	// extern const unsigned char [] MixpanelVersionString;
	[Field ("MixpanelVersionString", "__Internal")]
	byte[] MixpanelVersionString { get; }
}
